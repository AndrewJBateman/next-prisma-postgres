...
export default function Home({ initialUsers }) {
  ...
  return (
    <>
      <Head>
        <title>Next Admin Database</title>
        <link
          rel="stylesheet"
      ...
      <Container style={{ margin: 20 }}>
        <Header as="h3">
          This app is powered by NextJS and Semantic UI {pkg.version}
        </Header>
        <Form
          onSubmit={async () => {
          ...
          <Table.Body>
            {users.map((u, index) => (
              <Table.Row key={index}>
                <Table.Cell>
                  <Header as="h4" image>
                    <Image src={u.avatar} alt="user avatar image" rounded size="mini"></Image>
                    <Header.Content>
